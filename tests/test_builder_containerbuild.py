...
class TestBuilder(object):
    ...
    @pytest.mark.parametrize('annotations', (
        ...
        {'koji_task_annotations_whitelist': ['remote_source_url'], 'remote_source_url': 'stub_url'},
        {'remote_source_url': 'stub_url'},
        {'a': '1', 'b': '2'},
        {'koji_task_annotations_whitelist': ['a', 'b'], 'a': '1', 'b': '2', 'c': '3'},
        {'koji_task_annotations_whitelist': ['a', 'b'], 'a': '1', 'c': '3'}
        ))
    def test_write_annotations(self, tmpdir, annotations):
        annotations_file = tmpdir.join('build_annotations.json')
        cct = builder_containerbuild.BuildContainerTask(id=1,
                                                        method='buildContainer',
                                                        params='params',
                                                        session='session',
        ...
        cct.write_build_annotations(build_result, tmpdir)
